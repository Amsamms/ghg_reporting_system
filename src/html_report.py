...
<head>
    ...
    <title>GHG Emissions Report - PetrolCorp International</title>
...
<body>
    <div class="container">
        <header class="header">
            <h1><i class="fas fa-leaf"></i> GHG Emissions Report</h1>
            <p>PetrolCorp International - Comprehensive Environmental Assessment</p>
        ...
        <div class="content">
            <section id="overview" class="section">
                ...
                <div class="highlight">
                    ...
                    <p>This comprehensive GHG assessment provides a detailed analysis of PetrolCorp International's carbon footprint across all operational scopes. The report identifies key emission sources, tracks performance against industry benchmarks, and provides actionable recommendations for emission reduction strategies.</p>
                </div>
            </section>
        ...
        <footer class="footer">
            <p>&copy; 2024 PetrolCorp International - Sustainability Reporting</p>
            <p>Generated with Advanced GHG Reporting System</p>
        </footer>
    </div>
